...
# load save model
model_fraud = pickle.load(open('model_Predikksi_SMS.sav','rb'))

tfidf = TfidfVectorizer

loaded_vec = TfidfVectorizer(decode_error="replace", vocabulary=set(pickle.load(open("fitur_baru-_tf-idf.sav", "rb"))))
